...
ActiveRecord::Schema[7.0].define(version: 2023_09_11_213849) do
  ...
  create_table "groups_purchases", id: false, force: :cascade do |t|
    ...
    t.index ["group_id"], name: "index_groups_purchases_on_group_id"
    t.index ["purchase_id"], name: "index_groups_purchases_on_purchase_id"
  end
