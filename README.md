...
[Here you have a video to show the app in less than 5 mins!](https://www.loom.com/share/374232ef02f04848b4f7c0c8176d006d)
...
- **Create new categories for users**
- **Add transactions for each category**
- **All infomation is private between users**
...
```sh
  cd my-folder
  git clone https://github.com/enmanuelbayen/Budget-app.git
```
